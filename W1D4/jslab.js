...
//alert(findLongestWord(["dan","dani","daniel"]));
...
console.log("Expected output of reverse(Daniel) is leinaD  " + myFunctionTest("hsitfaH", reverse("Haftish"))); //reverse(str)
console.log("Expected output of findLongestWord([JS,is,awesome,and,easy]) is 7  " + myFunctionTest(7, findLongestWord(["JS","is","awesome","and","easy"]))); //findLongestWord(str)
